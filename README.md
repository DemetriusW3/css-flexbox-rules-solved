...
- E-commerce page:
  x - Grid view: /assets/images/e-commerce-page-grid-solved.png
  x - Lines view: /assets/images/e-commerce-page-lines-solved.png
  x - Lines-action view: /assets/images/e-commerce-page-lines-action-solved.png
...
- [x] The login input element. -[x] Should require a value.
